...
}`;function q(t,a){t&1&&bD(0,` Smoke `)}function B(t,a){t&1&&(bD(0,` Black`),Hp(1,`br`),bD(2,`hole `))}function G(t,a){t&1&&bD(0,` Noise `)}var W={noise:j,smoke:N,"black-hole":D};var E=class t{type=RL.required();fragmentShader=kD(()=>W[this.type()]);static ɵfac=function(e){return new(e||t)};static ɵcmp=aI({type:t,selectors:[[`app-shaders-page`]],hostVars:2,hostBindings:function(e,o){e&2&&pD(o.type())},inputs:{type:[1,`type`]},decls:5,vars:2,consts:[[1,`noise-container`,3,`fragmentShader`],[1,`title-section`]],template:function(e,o){if(e&1&&(Hp(0,`app-shader-preview`,0),Jo(1,`h1`,1),UI(2,q,1,0)(3,B,3,0)(4,G,1,0),dc()),e&2){let i;Vp(`fragmentShader`,o.fragmentShader()),Iy(2),$I((i=o.type())===`smoke`?2:i===`black-hole`?3:4)}},dependencies:[c],styles:[`[_nghost-%COMP%]{display:flex;width:100%;min-height:100vh;--%NS%shaders-page-background: unset;--%NS%shaders-page-label-color: black;--%NS%shaders-page-label-blend-mode: unset}.smoke[_nghost-%COMP%]{--%NS%shaders-page-background: #111;--%NS%shaders-page-label-color: white}.black-hole[_nghost-%COMP%]{--%NS%shaders-page-label-blend-mode: overlay}.noise-container[_ngcontent-%COMP%]{position:fixed;background:var(--%NS%shaders-page-background);z-index:-1}.title-section[_ngcontent-%COMP%]{margin:auto;text-align:center;font-size:clamp(8rem,15vw,30rem);font-family:sans-serif;text-transform:uppercase;color:var(--%NS%shaders-page-label-color);mix-blend-mode:var(--%NS%shaders-page-label-blend-mode)}`]})};export{E as ShadersPage};